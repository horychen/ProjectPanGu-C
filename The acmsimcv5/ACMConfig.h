...
#define MACHINE_TYPE 2
	// 电机参数
	#define PMSM_RESISTANCE                    1.97
	#define PMSM_D_AXIS_INDUCTANCE             0.10350000000000001
	#define PMSM_Q_AXIS_INDUCTANCE             0.1065
	#define PMSM_PERMANENT_MAGNET_FLUX_LINKAGE 0.0745
	// 铭牌值
	#define MOTOR_NUMBER_OF_POLE_PAIRS         24
	#define MOTOR_RATED_CURRENT_RMS            4.9504950495049505
	#define MOTOR_RATED_POWER_WATT             396.74689089653464
	#define MOTOR_RATED_SPEED_RPM              250
	#define MOTOR_SHAFT_INERTIA                0.0255
	// 参数误差
...
#define CURRENT_KP (71.8116)
#define CURRENT_KI (18.4977)
    #define CURRENT_KI_CODE (CURRENT_KI*CURRENT_KP*CL_TS)
#define CURRENT_LOOP_LIMIT_VOLTS (300)

#define SPEED_KP (0.0296806)
#define SPEED_KI (8.32454)
...
#define DATA_FILE_NAME "../dat/Yaojie_Motor-107-1000-0-28608.dat"
#endif

...
#define MACHINE_TYPE 2
	// 电机参数
	#define PMSM_RESISTANCE                    1.35
	#define PMSM_D_AXIS_INDUCTANCE             0.00166
	#define PMSM_Q_AXIS_INDUCTANCE             0.00172
	#define PMSM_PERMANENT_MAGNET_FLUX_LINKAGE 0.06480000000000001
	// 铭牌值
	#define MOTOR_NUMBER_OF_POLE_PAIRS         22
	#define MOTOR_RATED_CURRENT_RMS            5.516265912305517
	#define MOTOR_RATED_POWER_WATT             563.9755152143663
...
#define CURRENT_KP (2.42923)
#define CURRENT_KI (784.884)
    #define CURRENT_KI_CODE (CURRENT_KI*CURRENT_KP*CL_TS)
#define CURRENT_LOOP_LIMIT_VOLTS (120)

#define SPEED_KP (0.00020322)
...
#define DATA_FILE_NAME "../dat/TEST_PHIL_LAB_PID_CODES-225-1000-1-28951.dat"
#endif

...
#define DATA_LABELS "ACM.rpm_cmd,CTRL.I->rpm,nsoaf.xOmg*ELEC_RAD_PER_SEC_2_RPM,ENC.theta_d_elec,AFE_USED.theta_d,sin(ENC.theta_d_elec - AFE_USED.theta_d),INV.theta_trapezoidal/M_PI_OVER_180,INV.Vsat,INV.I5_plus_I7,INV.I11_plus_I13,INV.I17_plus_I19,INV.I5_plus_I7_LPF,INV.I11_plus_I13_LPF,INV.I17_plus_I19_LPF,INV.iD_atA,INV.iQ_atA,INV.uDcomp_atA,INV.uQcomp_atA,INV.ual_comp,ACM.dist_al,INV.ual_comp - ACM.dist_al,INV.ube_comp,ACM.dist_be,INV.ube_comp - ACM.dist_be,ACM.ial,ACM.ibe,sqrt(ACM.ial*ACM.ial+ACM.ibe*ACM.ibe),CTRL.O->udq_cmd[0],CTRL.O->udq_cmd[1],CTRL.I->idq_cmd[0],CTRL.I->idq[0],CTRL.I->idq_cmd[1],CTRL.I->idq[1],ACM.TLoad\n"

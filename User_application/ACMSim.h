...
#define ENCODER_TYPE   INCREMENTAL_ENCODER_QEP  // ABSOLUTE_ENCODER_MD1 // ABSOLUTE_ENCODER_SCI_SHANK
...
#define MOTOR2_OFFSET_COUNT_BETWEEN_ENCODER_INDEX_AND_U_PHASE_AXIS 30900 // cjh tuned with id_cmd = 3A, 20240715

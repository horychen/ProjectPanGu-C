...
#define printf                 DoNotCallPrintFunctionInDSP
    ...
    //        #define SYSTEM_CARRIER_PERIOD              (100000/SYSTEM_PWM_KILO_FREQUENCY) // = TBCLK (100 MHz) / 10 (kHz) = 100e6/1e4 = 100e2 = 1e4 cnt 閿熸枻鎷峰簲涓�閿熸枻鎷烽敓鎴鎷烽敓鏂ゆ嫹閿熸枻鎷�
    ...
    //#define SYSTEM_PWM_DEADTIME_CNT            500 // 500 閿熸枻鎷� TBCLK = EPWMCLK/1 = 100 MHz
    ...
    /* eCAP CONFIGURATION */ /* eCAP閿熸枻鎷烽敓渚ヨ鎷烽敓楗猴綇鎷烽敓娲ユ尝宄帮紵閿熷彨璁规嫹閿熸枻鎷烽敓鑺傜》鎷烽敓鏂ゆ嫹鍊奸敓鏂ゆ嫹20000閿熸枻鎷烽敓鏂ゆ嫹閿熸彮浼欐嫹閿熸枻鎷烽敓琛椼倧鎷烽敓绲婤CLK閿熸枻鎷烽敓鏂ゆ嫹棰戦敓鍓匡綇鎷烽敓鏂ゆ嫹閿熸枻鎷�200MHz閿熸枻鎷烽敓鏂ゆ嫹閿熸枻鎷�100MHz閿熸枻鎷� */
...
#define positive_current_QPOSCNT_counting_down (-1) // 姝ｅ悜鏃嬭浆鐨勭數娴佸鑷村閲忓紡缂栫爜鍣≦EP璇绘暟鍑忓皯 鍒欏～ -1锛屽惁鍒欓粯璁や负 1銆�
...
#define SHANK__OFFSET_COUNT_BETWEEN_ENCODER_INDEX_AND_U_PHASE_AXIS 5291918//yzz id = 4A 24.12.16 //7365433 // 1051014 // 3494662 // ym tuned with id_cmd = 3A 2024-03-12
...
#define CNT_2_ELEC_RAD (SYSTEM_QEP_REV_PER_PULSE * 2 * M_PI * d_sim.init.npp)
    ...
    #define SYSTEM_QEP_QPOSMAX (SYSTEM_QEP_PULSES_PER_REV - 1)
    #define SYSTEM_QEP_QPOSMAX_PLUS_1 (SYSTEM_QEP_PULSES_PER_REV)
    #define MOTOR1_OFFSET_COUNT_BETWEEN_ENCODER_INDEX_AND_U_PHASE_AXIS 205574 // tuned by iD=1A 20251108 266563
    #define MOTOR2_OFFSET_COUNT_BETWEEN_ENCODER_INDEX_AND_U_PHASE_AXIS 205574 // tuned by iD=1A 20251108 266563
#endif

...
void main_measurement(){
    ...
    // measure vdc
    Axis_1.vdc = ((REAL)(AdcaResultRegs.ADCRESULT0) - Axis->adc_offset[0]) * Axis->adc_scale[0];
    Axis_2.vdc = ((REAL)(AdcbResultRegs.ADCRESULT6) - Axis->adc_offset[0]) * Axis->adc_scale[0];

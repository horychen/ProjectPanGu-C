...
#define SYSTEM_QEP_PULSES_PER_REV 131072 // (8388608)
#define SYSTEM_QEP_REV_PER_PULSE  7.62939453125e-06 // (1.1920929e-7)
#define CNT_2_ELEC_RAD (SYSTEM_QEP_REV_PER_PULSE * 2 * M_PI * MOTOR_NUMBER_OF_POLE_PAIRS)
#define SYSTEM_QEP_QPOSMAX (SYSTEM_QEP_PULSES_PER_REV - 1)
#define SYSTEM_QEP_QPOSMAX_PLUS_1 (SYSTEM_QEP_PULSES_PER_REV)
#define OFFSET_COUNT_BETWEEN_ENCODER_INDEX_AND_U_PHASE_AXIS 82333 // 5874795 // cym can-encoder function output
...
#define DATA_FILE_NAME "../dat/TEST_PHIL_LAB_PID_CODES-225-1000-54-396.dat"

...
#define SIM_2_EXP_DEFINE_BEZIER_POINTS_X REAL x_tmp[5] = {0.0, 50.122034038142786, 21.18982652381805, 118.38132069370579, 500.0};
#define SIM_2_EXP_DEFINE_BEZIER_POINTS_Y REAL y_tmp[5] = {0.0, 2.8988083390546553, 2.1526641935649073, 2.9212099436665184, 3.0};
#endif
#endif
#endif

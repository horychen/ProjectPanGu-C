...
#define MA_SEQUENCE_LENGTH         60 // 40 for Yaojie large Lq motor  // Note MA_SEQUENCE_LENGTH * CL_TS = window of moving average in seconds
#define MA_SEQUENCE_LENGTH_INVERSE 0.016666666666666666 // 0.025                        // 20 MA gives speed resolution of 3 rpm for 2500 ppr encoder

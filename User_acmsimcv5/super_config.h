...
#define DATA_FORMAT "%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g\n"
#define DATA_LABELS "ACM.x[0],ACM.x[1],ACM.x[2],ACM.x[3],ACM.x[4],ACM.theta_d/M_PI*180,ACM.varOmega * MECH_RAD_PER_SEC_2_RPM,ACM.uAB[0],ACM.uAB[1],ACM.uDQ[0],ACM.uDQ[1],ACM.iAB[0],ACM.iAB[1],ACM.iDQ[0],ACM.iDQ[1],ACM.TLoad,ACM.Tem,ACM.KA,(*debug).set_rpm_speed_command,(*CTRL).s->xRho/M_PI*180,(*CTRL).i->cmd_varOmega * MECH_RAD_PER_SEC_2_RPM,(*CTRL).i->varOmega * MECH_RAD_PER_SEC_2_RPM,(*CTRL).i->cmd_varOmega,(*CTRL).i->varOmega,(*CTRL).i->cmd_iDQ[0],(*CTRL).i->cmd_iDQ[1],(*CTRL).o->cmd_uDQ[0],(*CTRL).o->cmd_uDQ[1],(*CTRL).o->dc_bus_utilization_ratio,(*CTRL).i->iDQ[0],(*CTRL).i->iDQ[1],(*CTRL).i->iAB[0],(*CTRL).i->iAB[1],(*CTRL).i->cmd_psi,(*CTRL).i->Tem,(*CTRL).i->cmd_Tem,(*debug).Overwrite_theta_d / ACM.npp,(*CTRL).timebase,ACM.KA,ACM.iDQ[0],ACM.iDQ[1],wubo_ParaMis.percent_Ld,wubo_ParaMis.percent_Lq,wubo_ParaMis.percent_Rs,wubo_ParaMis.percent_Js,wubo_ParaMis.percent_KE,SIL_Controller.KFB,(*CTRL).o->cmd_uAB[0],(*CTRL).o->cmd_uAB[1],(*CTRL).o->cmd_uAB_to_inverter[0],(*CTRL).o->cmd_uAB_to_inverter[1],(*CTRL).s->iD->OutLimit,(*CTRL).s->iQ->OutLimit,(*CTRL).s->Speed->Kp,(*CTRL).s->Speed->Ki_CODE,(*CTRL).o->dc_bus_utilization_ratio,(*CTRL).s->iD->Kp,(*CTRL).s->iD->Ki_CODE,(*CTRL).s->iQ->Kp,(*CTRL).s->iQ->Ki_CODE,ACM.theta_d/M_PI*180,(*CTRL).i->cmd_varTheta,(*CTRL).i->theta_d_elec * (*CTRL).motor->npp_inv,(*CTRL).i->varTheta\n"

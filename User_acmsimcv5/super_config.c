...
void init_d_sim() {
    ...
    d_sim.sim.NUMBER_OF_STEPS = 30000;
    ...
    d_sim.CL.SERIES_KP_D_AXIS = 12.566370614359172;
    d_sim.CL.SERIES_KI_D_AXIS = 240.0;
    d_sim.CL.SERIES_KP_Q_AXIS = 12.566370614359172;
    d_sim.CL.SERIES_KI_Q_AXIS = 240.0;
    d_sim.CL.LIMIT_DC_BUS_UTILIZATION = 0.96;

    d_sim.VL.SERIES_KP = 0.2435343142317669;
    d_sim.VL.SERIES_KI = 25.132741228718345;

...
void init_d_sim() {
    ...
    d_sim.init.Rreq = 0.0;
    d_sim.init.Js = 0.00030000000000000003;
    d_sim.init.Vdc = 60;

    d_sim.sim.INVERTER_NONLINEARITY = 0;
    d_sim.sim.CLTS = 0.0001;
    d_sim.sim.NUMBER_OF_STEPS = 60000;
    ...
    d_sim.CL.SERIES_KP_D_AXIS = 6.976848965092213;
    d_sim.CL.SERIES_KI_D_AXIS = 708.8288904899135;
    d_sim.CL.SERIES_KP_Q_AXIS = 6.976848965092213;
    d_sim.CL.SERIES_KI_Q_AXIS = 708.8288904899135;
    d_sim.CL.LIMIT_DC_BUS_UTILIZATION = 0.96;

    d_sim.VL.SERIES_KP = 0.12050962978722203;
    d_sim.VL.SERIES_KI = 30.349886763335768;
    ...
    d_sim.user.max_CLBW_PER_min_CLBW = 0.1;

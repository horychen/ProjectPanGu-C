...
void init_d_sim() {
    ...
    d_sim.CL.SERIES_KP_D_AXIS = 2.7313006530309663;
    d_sim.CL.SERIES_KI_D_AXIS = 209.21804888888886;
    d_sim.CL.SERIES_KP_Q_AXIS = 2.7313006530309663;
    d_sim.CL.SERIES_KI_Q_AXIS = 209.21804888888886;
    d_sim.CL.LIMIT_DC_BUS_UTILIZATION = 0.96;

    d_sim.VL.SERIES_KP = 0.48402548475680274;

...
//
#if CPU_FRQ_200MHZ
//#define SPI_BRR        ((200E6 / 4) / 500E3) - 1 // �����BRRҲ���ܣ�����SPI�����Ƶ�ʾ��ǽ����˴��ʮ���ɡ���
...
void InitSpi(void)
{
    ...
    GpioDataRegs.GPBSET.bit.GPIO61 = 1;             //cs=1Ϊ��һ����׼��
...
// Comment out other unwanted lines.
    ...
    //GpioCtrlRegs.GPBQSEL2.bit.GPIO61 = 3; // Asynch input GPIO19 (SPISTEA) // ��MAX5307ͨѶ������Ҫ���������ϵ� SPISTEA ���ܣ�GPIO61��Ϊ��ͨ��GPIOʹ�ü��ɣ���Ҫ��GPIO61��ʹ��Ȩ����Ȩ��CPU02�������������void Gpio_initialize(void)
...
// Comment out other unwanted lines.
    ...
    //GpioCtrlRegs.GPBMUX2.bit.GPIO61 = 3; // Configure GPIO19 as SPISTEA // ��MAX5307ͨѶ������Ҫ���������ϵ� SPISTEA ���ܣ�GPIO61��Ϊ��ͨ��GPIOʹ�ü��ɣ���Ҫ��GPIO61��ʹ��Ȩ����Ȩ��CPU02�������������void Gpio_initialize(void)
